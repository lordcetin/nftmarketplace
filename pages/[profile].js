    ...
    const onChangeProfile = async (e) => {
     ...
     const updateBannerContent = async (e) => {
      ...
      try {
         ...
         await fetch('https://testmarket.cos-in.com/api/update',{
         method:'PUT',
...
export const getServerSideProps = async (context) => {
  const res = await fetch(`https://testmarket.cos-in.com/api/users`)
  const resnft = await fetch(`https://testmarket.cos-in.com/api/setnft`)
