  ...
  {matches => (
    <Fragment>
      {matches.small &&
        ...
        {allauction.filter(u => u.duration +'000' < Date.now()).map((i,k) =>
          <div key={k} className="w-[300px] text-slate-400">
            ...
            <div className="flex justify-center items-center">{i.type == "video/mp4"
            ? <video src={i.image} autoPlay loop muted className="h-[300px] flex justify-center items-center object-cover overflow-hidden"/>
            ...
            : <Link href={`/auctiondetails/${i.id}`} className='flex justify-center relative bottom-3 bg-gradient-to-tr to-slate-900 z-30 border-[1px] border-slate-700 rounded-b-lg from-slate-900 hover:to-purple-600 hover:from-blue-700 w-full h-10 text-slate-400'>Start Offer</Link>
            }
            </div>
            </div>
          </div>  
      ...
      {matches.medium &&
        ...
        {allauction.filter(u => u.duration + '000' < Date.now()).map((i,k) =>
          <div key={k} className="w-[300px] text-slate-400">
            ...
            : <Link href={`/auctiondetails/${i.id}`} className='relative bottom-3 bg-gradient-to-tr to-slate-900 z-30 border-[1px] border-slate-700 rounded-b-lg from-slate-900 hover:to-purple-600 hover:from-blue-700  flex justify-center w-full h-10 text-slate-400'>Start Offer</Link>
            }
            </div>
            </div>
          </div>  
...
export default AllAuctionNftCard;
