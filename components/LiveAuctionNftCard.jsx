...
<Media queries={{
  ...
  {matches => (
      <Fragment>
        {matches.small &&
          <Fragment>
            {liveauction.filter(u => u.duration < Date.now()).map((i,k) =>
              ...
              <Link href={`/auctiondetails/${i.id}`}>{i.type == "video/mp4"
        ...
        {matches.large &&
          ...
          <div className='grid grid-cols-5 gap-5'>
            {liveauction.filter(u => u.duration < Date.now()).map((i,k) =>
              ...
              <Link href={`/auctiondetails/${i.id}`}>{i.type == "video/mp4"
              ? <video src={image} autoPlay loop muted className='h-[300px] flex justify-center items-center object-cover overflow-hidden'/>
              : i.type == "image/png" || i.type == "image/jpeg" || i.type == "image/jpg" || i.type == "image/svg" || i.type == "image/webp"
